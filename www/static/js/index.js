    ...
    _createClass(Home, [{
            ...
            $('#fullpage').fullpage({
                ...
                onLeave: function onLeave(index, nextIndex, direction) {
                    ...
                    if (index == 1 && direction == 'down' && scrollFlag) {
                        ...
                        var tm = new _gsap.TimelineLite({ onComplete: function onComplete() {
        ...
        value: function parallaxAnimation() {
            ...
            var update = function update() {
                ...
                _gsap.TweenLite.to(_this3.selector.$scr_sun, .5, {
                    x: dx / 10,
                    y: dy / 15,
                    ease: Power1.easeOut
                });
                _gsap.TweenLite.to(_this3.selector.$scr_cloud, .5, {
                    x: dx / 14,
                    y: dy / 15,
                    ease: Power1.easeOut
                });
                _gsap.TweenLite.to(_this3.selector.$scr_b_small, .5, {
                    x: dx / 10,
                    y: dy / 15,
                    ease: Power1.easeOut
                });
                _gsap.TweenLite.to(_this3.selector.$scr_b_big, .5, {
                    x: dx / 20,
                    y: dy / 15,
                    ease: Power1.easeOut
                });
                _gsap.TweenLite.to(_this3.selector.$scr_m_left, .5, {
                    x: dx / 40,
                    y: dy / 30,
                    ease: Power1.easeOut
                });
                _gsap.TweenLite.to(_this3.selector.$scr_m_right, .5, {
                    x: dx / 40,
                    y: dy / 30,
                    ease: Power1.easeOut
                });
                _gsap.TweenLite.to(_this3.selector.$scr_snow, .5, {
                    x: dx / 40,
                    y: dy / 30,
                    ease: Power1.easeOut
                });
                _gsap.TweenLite.to(_this3.selector.$scr_cloud_r, .5, {
                    x: dx / 10,
                    y: dy / 15,
                    ease: Power1.easeOut
                });
                _gsap.TweenLite.to(_this3.selector.$scr_cloud_l, .5, {
                    x: dx / 14,
                    y: dy / 15,
                    ease: Power1.easeOut
                });
        ...
        value: function citiesTabParallaxAnimation() {
            ...
            var update = function update() {
                ...
                _gsap.TweenLite.to($('.canada_bg, .america_bg, .mexica_bg'), .5, {
                    x: dx / 40,
                    y: dy / 70,
                    ease: Power1.easeOut
                });
                _gsap.TweenLite.to($('.canada_clouds, .america_clouds_sun, .mexica_clouds'), .5, {
                    x: dx / 30,
                    y: dy / 70,
                    ease: Power1.easeOut
                });
                _gsap.TweenLite.to($('.canada_forest, .america_buildings, .mexica_buildings'), .5, {
                    x: dx / 20,
                    y: dy / 70,
                    ease: Power1.easeOut
                });
                _gsap.TweenLite.to($('.canada_ground, .america_ground, .mexica_ground'), .5, {
                    x: dx / 50,
                    y: dy / 50,
                    ease: Power1.easeOut
                });
                _gsap.TweenLite.to($('.canada_truck, .america_truck, .mexica_truck'), .5, {
                    x: dx / 50,
                    y: dy / 60,
                    ease: Power1.easeOut
                });
